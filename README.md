    ...
    - - [Quick Start](#-quick-start)
      - - [Example Prompts](#-example-prompts)
        - - [Links](#-links)
          ...
          ⚡ **Real-time Execution** — Launch, pause, and manage campaigns instantly
          ...
          ### ⚙️ **Execution**
          Launch new campaigns, pause underperforming ads, and manage accounts across all platforms in seconds.
          ...
          - - ✔️ **Claude Max** subscription OR **ChatGPT** plan supporting custom connectors
            - - ✔️ Connected Meta and Google ad accounts in Agency AI
              ...
              2. 2. Click your profile → **Settings** → **Connectors**
                 3. 3. Click **Add custom connector**
                    4. 4. Paste: `https://s.agencyai.app/mcp`
                       5. 5. Sign in with your Agency AI account when prompted
                          6. 6. ✅ Done! Start asking Claude about your ads
                            
                             7. ### 💬 ChatGPT Setup
                            
                             8. 1. Open **ChatGPT** (chatgpt.com)
                                2. 2. Click your profile → **Settings** → **Connectors**
                                   3. 3. Click **Add connector**
                                      4. 4. Paste: `https://s.agencyai.app/mcp`
                                         5. 5. Sign in with your Agency AI account when prompted
                                            6. 6. ✅ Done! Start asking ChatGPT about your ads
                                              
                                               7. > 📖 **Need detailed steps?** See [llms-install.md](./llms-install.md) for a complete walkthrough with screenshots.
                                                  >
                                                  > ---
                                                  >
                                                  > ## 💬 Example Prompts
                                                  ...
                                                  > "Scale my top performer by 30% budget"
                                                  > "Create a new campaign with these specs: [your details]"
                                                  > ```
                                                  >
                                                  > ---
                                                  >
                                                  ...
                                                  **Ready to supercharge your ad management?**

                                                  [🚀 Get Started](https://agencyai.app) • [📖 Read Docs](./llms-install.md) • [💬 Get Support](mailto:hello@agencyai.app)
